...
const invitations = [
  { href: '/groom', label: 'Nhà trai', name: wedding.groom.name, photo: wedding.groom.photo, position: 'object-[50%_36%]' },
  { href: '/bride', label: 'Nhà gái', name: wedding.bride.name, photo: wedding.bride.photo, position: 'object-[50%_41%]' },
]
